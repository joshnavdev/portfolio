export const theme = {
  navbar: {
    toggle: {
      base: 'inline-flex items-center rounded-lg p-2 text-sm text-nord-6 hover:bg-nord-5 focus:outline-none focus:ring-2 focus:ring-nord-5 dark:text-nord-6 dark:hover:bg-nord-3 dark:focus:ring-nord-3 md:hidden',
    },
    root: {
    ...
    collapse: {
      list: 'mt-4 flex flex-col md:mt-0 md:flex-row md:space-x-8 bg-nord-3 md:bg-transparent dark:md:bg-transparent p-2 md-p-0 rounded-lg',
    },
  },
  button: {
    color: {
